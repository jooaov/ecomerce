...
<form method="post" action="https://pagseguro.uol.com.br/v2/checkout/payment.html">
    ...
    <!-- Campos obrigatórios -->
    <input name="receiverEmail" type="hidden" value="jjoao.jv13@gmail.com">
    ...
    <input name="itemWeight<?php echo htmlspecialchars( $counter1+1, ENT_COMPAT, 'UTF-8', FALSE ); ?>" type="hidden" value="<?php echo htmlspecialchars( $value1["vlweight"]*1000, ENT_COMPAT, 'UTF-8', FALSE ); ?>"> <?php } ?>
